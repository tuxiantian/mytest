...
/** 
 * ZXing工具类 
 * @version v1.0 -->方法新建,目前仅支持二维码的生成和解析,生成二维码时支持添加logo头像 
 * @see ----------------------------------------------------------------------------------------------------------------------- 
...
public class ZXingUtilIo {  
     ...
     */ 
    public static BufferedImage  encodeQRCodeImage(String content, String charset, int width, int height, String logoPath) {  
     ...
     * @throws IOException 
     */ 
    public static void  encodeQRCode(String content, String charset, int width, int height,OutputStream stream) throws IOException {  
        Map<EncodeHintType, Object> hints = new HashMap<EncodeHintType, Object>();  
        //指定编码格式  
        //hints.put(EncodeHintType.CHARACTER_SET, "UTF-8");  
        //指定纠错级别(L--7%,M--15%,Q--25%,H--30%)  
