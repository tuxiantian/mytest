...
public final class DateUtil {
	...
	/**
	 * 将date从patternfrom格式转为patternto格式的字符串
	 * @param date 日期字符串
	 * @param pattern 日期格式<br>
	 * 				     建议使用DateUtil中DATE_PATTERN里面定义的值
	 * @return
	 */
	public static String date2String(String date,String patternfrom,String patternto){
		if (date == null || patternfrom == null||patternto==null) {
			throw new IllegalArgumentException("date and patternfrom and patternto must not be null");
		}
	 ...
	 * @param str1
	 * @param str2
	 * @param unit DateUtil类里面的枚举TimeUnit,可选值有(day:天,hour:小时,min:分钟,sec:秒)
	 * @return
	 */
	 ...
	 * @param date
	 * @param add
	 * @param unit DateUti类中的枚举TimeUnit,可选值有(day:天,hour:小时,min:分钟,sec:秒)
	 * @return
	 */
